...
- Pin image commands -  If there is no pinned image, Kick and CB will use thumbnail images from the video feed, OF/Fans will embed images from the image list. 
